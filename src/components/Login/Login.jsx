                    ...
                    <form onSubmit={handleLogin} className="mt-6 space-y-4">
                        ...
                        <div className="form-control">
                            ...
                            <div className="relative">
                                <input type={showPassword ? "text" : "password"} name="password" placeholder="Enter your password" className="input input-bordered w-full pr-10 bg-gradient-to-r from-purple-700 to-pink-500" required />
                        ...
                        <div className="form-control mt-4">
                            <button type="submit" className="btn bg-gray-500 text-white w-full">Login</button>
                        </div>
                        ...
                        <div className="text-center mt-4">
                            <p className="text-gray-600">Don't have an account? <Link to="/register" className="text-purple-600 hover:underline">Register now</Link></p>
                        </div>
                    </form>
                </div>
            </div>
