...
const Navbar = () => {
    ...
    const links = (
        <>
            ...
            <li><NavLink to="/AboutUsPage" className={({ isActive }) => isActive ? "bg-purple-800 text-white px-4 py-2 rounded-md" : "hover:bg-indigo-500 hover:underline px-4 py-2 rounded-md"}>About Us</NavLink></li>
